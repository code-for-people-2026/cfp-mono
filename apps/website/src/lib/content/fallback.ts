...
export const neighborsPageFallback: NeighborsPageContent = neighborsPage;
...
export const settingsFallback: SiteSettings = {
  ...
  brand: { wordmark: "码成仝", tagline: "为“工友”敲键盘", logoPath: brandAssets.logoSrc, logoAlt: "码成仝 logo" },
  headerNav: [
