import { getChatPage, getFeaturedProduct, getHomepage, getSiteSettings, getUiStrings } from "@/lib/content";
...
export default async function DialoguePage({
  ...
  const [chat, ui, home, settings, featuredProduct] = await Promise.all([
    getChatPage(),
    getUiStrings(),
    getHomepage(),
    getSiteSettings(),
