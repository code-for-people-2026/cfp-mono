...
> 定位描述沿用"社区私房菜助手"。
> 状态：草稿 v1.12 ｜ 最近更新：2026-07-13 ｜ 负责人：码成工小队
...
- 如果现有订单已 confirmed，更新前必须二次确认，并明确会同步影响订单台账、送餐清单和收款汇总；若已经 paid/reconciled 或 fulfillment=done，则完整接龙不得自动更新或取消，提示桃子单独处理。
