...
grep -q 'DEEPSEEK_API_KEY: \${{ secrets.DEEPSEEK_API_KEY }}' "$ci_workflow"
grep -q '\[\[ -n "$DEEPSEEK_API_KEY" \]\]' "$ci_workflow"
grep -q -- '--env DEEPSEEK_API_KEY="$DEEPSEEK_API_KEY"' "$ci_workflow"
