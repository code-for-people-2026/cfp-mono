...
| PR2 | 保证旧响应不能覆盖新意图且编辑保持原位 | US1-US3、FR-003/004/006/008~010/015 | `apps/kith-inn-v1-fe/src/logic/offeringsView*`、`apps/kith-inn-v1-fe/src/pages/merchant/offerings/index.tsx`、`docs/kith-inn-v1/TECH-SPEC.md`、`docs/kith-inn-v1/USER-STORIES.md` | 不做高保真视觉调整 | lint、typecheck、coverage、定向 E2E、长期文档一致性核对 | 约 400 行 | PR-Assets |
