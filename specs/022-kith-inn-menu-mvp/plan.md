...
日期：2026-09-20 · 状态：契约、持久化、会话与菜池API已实现并独立审查，尚未合并 · 来源：[功能规格](spec.md)、[数据模型](data-model.md)、[接口契约](contracts/openapi.json)

本计划只交付菜池、排周菜单、保存回看和单餐文字复制。经营者只有桃子；订单、对账、连续订餐继续在首版之外。实施按 #357～#360 成果推进；当前已完成契约、持久化、会话和菜池API切片自检，未宣称功能整体交付或发布。
